...
namespace Gothic_I_Addon {
  ...
  struct zTBSphere3D {
    ...
    // user API
    #if __has_include("zTBSphere3D.inl")
  ...
  struct zTBCylinder3D {
    ...
    // user API
    #if __has_include("zTBCylinder3D.inl")
  ...
  public:
    ...
    // user API
    #if __has_include("zCOBBox3D.inl")
